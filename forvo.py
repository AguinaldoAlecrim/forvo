...
class Forvo:
    ...
    def repetir_audio(self):
        ...
        Args:
            ...
            vezes (int): O número de vezes que o áudio será repetido (padrão é 1).

        Returns:
            None.
        """
        audio_data_copy = BytesIO(self.LASTAUDIO)
        try:
            # Inicializa a biblioteca pygame
            pygame.mixer.init()
    ...
    def play(self, word: str):
        ...
        if len(parameters) > 0:
            ...
            self.LASTAUDIO=self._reproduzir_audio(self._getUrlMp3(base64Code))
            return True
        return False
